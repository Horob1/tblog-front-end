        ...
        <div className='max-w-[1240px] mx-auto '>
            <div className='grid lg:grid-cols-3 sm:grid-cols-3 ss:grid-cols-1  md:gap-x-8 sm:gap-y-8 ss:gap-y-8 px-4 sm:pt-20 md:mt-0 ss:pt-20 text-black'>
                <div className='col-span-2 gap-x-8 gap-y-8'>
                    <img src={blogs.coverImg} alt="cover img" className='h-56 w-full object-cover' />
                    <h1 className='font-bold text-2x1 my-1 pt-5'>{blogs.title}</h1>
                    <p className='pt-5 text-gray-500'>Creat At</p>
                    <div className='pt-5'><p>{blogs.content}</p></div>
                </div>
                <div className='w-full bg-white rounded-x1 overflow-hidden drop-shadow-md py-5 max-h-[250px]'>
                    <div>
                        <img className='p-2 w-32 h-32 rounded-full mx-auto' src={blogs.authorImg} alt="avata" />
                        <h1 className=' font-bold text-2x1 text-center text-gray-900 pt-3'>{blogs.authorName}</h1>
                        <p className='text-center text-gray-900 font-medium'>{blogs.authorDesc}</p>
                    </div>
